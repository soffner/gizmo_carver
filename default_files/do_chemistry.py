...
start_time = time.time()
output_interp_despotic_co = interpolate_5d(nharray, NHarray, Tgarray, isrfarray, xH2array, despout_co, 
                                           input_interp_despotic)
end_time = time.time()
...
start_time = time.time()
output_interp_despotic_hcop = interpolate_5d(nharray, NHarray, Tgarray, isrfarray, xH2array, despout_hcop, 
                                             input_interp_despotic)
end_time = time.time()
...
#now interpolate
start_time = time.time()
output_interp_uclchem_co = interpolate_5d(nharray, NHarray_new, Tgarray_new, isrfarray_new, xH2array, 
                                          uclout_co, input_interp_uclchem)
end_time = time.time()
...
#now interpolate
start_time = time.time()
output_interp_uclchem_hcop = interpolate_5d(nharray, NHarray_new, Tgarray_new, isrfarray_new, xH2array, 
                                            uclout_hcop, input_interp_uclchem)
end_time = time.time()
...
#now interpolate
start_time = time.time()
output_interp_uclchem_hcn = interpolate_5d(nharray, NHarray_new, Tgarray_new, isrfarray_new, xH2array, 
                                           uclout_hcn, input_interp_uclchem)
end_time = time.time()
...
#reopen CO, HCO+ and HCN abundances and make them 0 if the temperature > max temperature available in
#lamda leiden database for collision rates 
