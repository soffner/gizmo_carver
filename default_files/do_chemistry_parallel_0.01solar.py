...
ncpus=48
path = '/g/data1b/jh2/ps3459/starforge_data/45/'
snap = '300'
...
info = {'xC':1.77e-6, 'xO':3.34e-6, 'xC+':0, 'xCO':0, 'xO+':0} #0.01 Solar
...
uclout_co = np.loadtxt(ucl_path+'uclout_5D_CO_0.01solar.txt', delimiter=',')
uclout_hcop = np.loadtxt(ucl_path+'uclout_5D_HCOp_0.01solar.txt', delimiter=',')
uclout_hcn = np.loadtxt(ucl_path+'uclout_5D_HCN_0.01solar.txt', delimiter=',')
uclout_hnc = np.loadtxt(ucl_path+'uclout_5D_HNC_0.01solar.txt', delimiter=',')
