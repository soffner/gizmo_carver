#new script created in Jun 2024. old one is called new_fields_list_old.py
import yt
import inputs_gizmo_carver as inputs
from yt.units import *
import numpy as np

def add_custom_fields(ds):
    ...
    def _gas_temp_C(field, data):
        return data[('PartType0', 'Temperature')] * yt.YTQuantity(1, 'K') * ( data[('PartType0','Temperature')] < yt.YTArray([200], 'K') ) #200 is the max temp av$
    ...
    def _CNumberDensityUCLCHEM(field, data):
        c_numdens = data[('PartType0', 'CAbundUCLCHEM')] * data[('PartType0', 'Density')].to('g/cm**3') / (inputs.mol_hydrogen_ratio*yt.YTQuantity(mh, 'g'))
        return c_numdens
    ...
    # Add all the fields
    ds.add_field(("PartType0", "NumberDensity"), function=_NumberDensity, units="cm**-3", sampling_type='particle', force_override=True)
    ds.add_field(("PartType0", "ElectronNumberDensity"), function=_ElectronNumberDensity, units="cm**-3", sampling_type='particle', force_override=True)

    ds.add_field(("PartType0", "gas_temperature_CO"), function=_gas_temp_CO, units="K", sampling_type='particle', force_override=True)
    ds.add_field(("PartType0", "gas_temperature_HCOp"), function=_gas_temp_HCOp, units="K", sampling_type='particle', force_override=True)
    ds.add_field(("PartType0", "gas_temperature_HCN"), function=_gas_temp_HCN, units="K", sampling_type='particle', force_override=True)
    ds.add_field(("PartType0", "gas_temperature_HNC"), function=_gas_temp_HNC, units="K", sampling_type='particle', force_override=True)
    #ds.add_field(("PartType0", "gas_temperature_C"), function=_gas_temp_C, units="K", sampling_type='particle', force_override=True)

    ds.add_field(("PartType0", "dust_temperature"), function=_DustTemperature, units="K", sampling_type='particle', force_override=True)

    ds.add_field(('PartType0', 'DustDensity'), function=_DustDensity, units='g/cm**3', sampling_type='particle', force_override=True)

    ds.add_field(('PartType0', 'H2ColumnDensity'), function=_H2ColumnDensity, units='cm**-2', sampling_type='particle', force_override=True)

    ds.add_field(('PartType0', 'H2NumDensity'), function=_H2NumDensity, units='cm**-3', sampling_type='particle', force_override=True)

    ds.add_field(('PartType0', 'CONumberDensityDefault'), function=_CONumberDensityDefault, units='cm**-3', sampling_type='particle', force_override=True)

    ds.add_field(('PartType0', 'CONumberDensityDespotic'), function=_CONumberDensityDespotic, units='cm**-3', sampling_type='particle', force_override=True)
    ds.add_field(('PartType0', '13CONumberDensityDespotic'), function=_13CONumberDensityDespotic, units='cm**-3', sampling_type='particle', force_override=True)
    ds.add_field(('PartType0', 'C18ONumberDensityDespotic'), function=_C18ONumberDensityDespotic, units='cm**-3', sampling_type='particle', force_override=True)

    ds.add_field(('PartType0', 'HCOpNumberDensityDespotic'), function=_HCOpNumberDensityDespotic, units='cm**-3', sampling_type='particle', force_override=True)
    ds.add_field(('PartType0', 'H13COpNumberDensityDespotic'), function=_H13COpNumberDensityDespotic, units='cm**-3', sampling_type='particle', force_override=True)

    ds.add_field(('PartType0', 'CONumberDensityUCLCHEM'), function=_CONumberDensityUCLCHEM, units='cm**-3', sampling_type='particle', force_override=True)
    ds.add_field(('PartType0', '13CONumberDensityUCLCHEM'), function=_13CONumberDensityUCLCHEM, units='cm**-3', sampling_type='particle', force_override=True)
    ds.add_field(('PartType0', 'C18ONumberDensityUCLCHEM'), function=_C18ONumberDensityUCLCHEM, units='cm**-3', sampling_type='particle', force_override=True)

    ds.add_field(('PartType0', 'HCOpNumberDensityUCLCHEM'), function=_HCOpNumberDensityUCLCHEM, units='cm**-3', sampling_type='particle', force_override=True)
    ds.add_field(('PartType0', 'H13COpNumberDensityUCLCHEM'), function=_H13COpNumberDensityUCLCHEM, units='cm**-3', sampling_type='particle', force_override=True)

    ds.add_field(('PartType0', 'HCNNumberDensityUCLCHEM'), function=_HCNNumberDensityUCLCHEM, units='cm**-3', sampling_type='particle', force_override=True)
    ds.add_field(('PartType0', 'HNCNumberDensityUCLCHEM'), function=_HNCNumberDensityUCLCHEM, units='cm**-3', sampling_type='particle', force_override=True)
    #ds.add_field(('PartType0', 'CNumberDensityUCLCHEM'), function=_CNumberDensityUCLCHEM, units='cm**-3', sampling_type='particle', force_override=True)

    ds.add_field(("PartType0", "microturbulence_speed"), function=_MicroTurb, units="cm/s", sampling_type='particle', force_override=True)
